...
describe("NavigationProductSwitcherComponent", () => {
  ...
  describe("other products", () => {
    ...
    it("shows Organizations first in the other products list", () => {
      mockProducts$.next({
        bento: [],
        other: [
          { name: "AA Product", icon: "fa-lock", marketingRoute: "https://www.example.com/" },
          { name: "Test Product", icon: "fa-lock", marketingRoute: "https://www.example.com/" },
          { name: "Organizations", icon: "fa-lock", marketingRoute: "https://www.example.com/" },
        ],
      });
  ...
  describe("available products", () => {
    it("shows all products", () => {
      mockProducts$.next({
        bento: [
          { isActive: true, name: "Password Manager", icon: "fa-lock", appRoute: "/vault" },
          { isActive: false, name: "Secret Manager", icon: "fa-lock", appRoute: "/sm" },
        ],
        other: [],
      });
  ...
  it("links to `appRoute`", () => {
    mockProducts$.next({
      bento: [{ isActive: false, name: "Password Manager", icon: "fa-lock", appRoute: "/vault" }],
      other: [],
    });
