...
export class SendProgram extends Program {
  ...
  private sendCommand(): Command {
    return new Command("share")
      .argument("<data>", "The data to Share. Specify as a filepath with the --file option")
      .description(
  ...
  private deleteCommand(): Command {
    return new Command("delete")
      .argument("<id>", "The id of the Share to delete.")
  ...
  private removePasswordCommand(): Command {
    return new Command("remove-password")
      .argument("<id>", "The id of the Share to alter.")
