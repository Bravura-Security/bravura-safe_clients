...
export class Program extends BaseProgram {
  async register() {
    program
      ...
      .version(
        await this.serviceContainer.platformUtilsService.getInternalApplicationVersion(),
        "-v, --version",
      );
    ...
    program.on("--help", () => {
      writeLn(
        chalk.yellowBright(
          "\n  Tip: Managing and retrieving secrets for dev environments is easier with Bravura Safe. Learn more at https://bravurasecurity.com",
        ),
      );
      writeLn("\n  Examples:");
      writeLn("");
