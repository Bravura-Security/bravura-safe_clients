...
export const ForceActiveStyles: Story = {
  render: (args: NavItemComponent) => ({
    props: args,
    template: `
      <bit-nav-item text="First Nav" icon="fa-collection"></bit-nav-item>
      <bit-nav-item text="Active Nav" icon="fa-collection" [forceActiveStyles]="true"></bit-nav-item>
      <bit-nav-item text="Third Nav" icon="fa-collection"></bit-nav-item>
    `,
  }),
};
