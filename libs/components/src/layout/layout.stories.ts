    ...
    template: /* HTML */ `
      <bit-layout>
        <bit-side-nav>
          ...
          <bit-nav-group text="Tree A" icon="fa-people" [open]="true">
            <bit-nav-group
          ...
          <bit-nav-group text="Tree B" icon="fa-collection" [open]="true">
            <bit-nav-group
              text="Level 1 - with children (empty)"
              route="#"
              icon="fa-collection"
          ...
          <bit-nav-group text="Tree C" icon="fa-key" [open]="true">
            <bit-nav-group
              text="Level 1 - with children (empty)"
              route="#"
              icon="fa-collection"
    ...
    template: /* HTML */ `
      <bit-layout>
        <bit-side-nav variant="secondary">
          <bit-nav-item text="Item A" icon="fa-collection"></bit-nav-item>
          <bit-nav-item text="Item B" icon="fa-collection"></bit-nav-item>
          <bit-nav-divider></bit-nav-divider>
          <bit-nav-item text="Item C" icon="fa-collection"></bit-nav-item>
          <bit-nav-item text="Item D" icon="fa-collection"></bit-nav-item>
